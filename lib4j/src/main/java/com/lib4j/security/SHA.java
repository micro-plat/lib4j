...
public class SHA {
    ...
    public static String sha1(String plainText) {
        return getSha(plainText, SHA_1);
    }

    public static String sha224(String plainText) {
        return getSha(plainText, SHA_224);
    }

    public static String sha256(String plainText) {
        return getSha(plainText, SHA_256);
    }

    public static String sha384(String plainText) {
        return getSha(plainText, SHA_384);
    }

    public static String sha512(String plainText) {
        return getSha(plainText, SHA_512);
    }

    private static String getSha(String plainText, String algorithm) {
        // 输入的字符串转换成字节数组
